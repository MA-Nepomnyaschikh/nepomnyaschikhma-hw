...
import autotesting.practice_7.models.enams.UserRole;
...
public class UserData {
    ...
    public static final String ADMIN_LOGIN = Config.getProperty("admin.username");
    ...
    public static CreateUserRequestDto generateAdminDto() {
