package testdata.expectedmessages.ui;
...
public class AccountUiMessages {
    ...
    public static final String TRANSFER_AMOUNT_IS_INVALID = "❌ Error: Invalid transfer: insufficient funds or invalid accounts";
